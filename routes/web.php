...
Route::prefix($city)->group(function () {
    ...
    Route::group(['middleware'=>['auth','agent']],function(){
        ...
        Route::post('/add-cemetery-agent', [AgentController::class, 'addCemetery'])->name('agent.add.cemetery');
    ...
    Route::group(['middleware'=>['auth','organization']],function(){
        ...
        Route::get('/account/agency/settings', [AgencyController::class, 'organizationSettings'])->name('account.organization.settings');
