...
class AgencyService {
    ...
    public static function index(){
        ...
        return view('account.organization.index',compact('user','last_orders_services','page'));
    }
    ...
    public static function organizationSettings(){
        ...
        $imgs_agent=ImageAgency::where('user_id',$user->id)->get();
        return view('account.organization.settings',compact('user','page','imgs_agent','cemeteries'));
