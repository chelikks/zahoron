...
<section class="order_page bac_gray">
    <div class="container">
        <div class="content_order_page">
            <div class="index_title">Колумбарии</div>    
        </div>
...
<section class="cemetery">
    <div class="container">
        ...
        <div class="block_cemetery">
            <div class="title_our_works">Список колумбариев</div>

            <div class="ul_cemeteries">
                @if (isset($columbariums) && $columbariums->count()>0)
                <?php $k=1;?>
                    @foreach ($columbariums as $columbarium)
                        <a href="{{ route('columbarium.single',$columbarium->id) }}" class="li_cemetery">
...
<section class="map_cemeteries">
    <div class="container">
        <div class="title_our_works">Карта колумбариев</div>
    ...
    @foreach($columbariums as $columbarium)
      myMap.geoObjects
        .add(new ymaps.Placemark(['{{$columbarium->width}}', '{{$columbarium->longitude}}'], {
            balloonContent: '{{$columbarium->title}}',
