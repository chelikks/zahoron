    ...
    <div class="container">  
        ...
        @if (isset($page))
            <div class='pages'>
                ...
                <a href='{{ route('account.organization.beautifications.index') }}'class="btn_bac_gray <?php if($page==4){echo ' active_label_product';}?>"class="btn_bac_gray">Облагораживание</a>
                <a href='{{ route('account.organization.services.index') }}'class="btn_bac_gray <?php if($page==3){echo ' active_label_product';}?>">Уборка захоронений</a>
                <a href='{{ route('account.organization.settings') }}'class="btn_bac_gray <?php if($page==5){echo ' active_label_product';}?>">Настройки</a>
                <a href='#'class="btn_bac_gray">Чат</a>
            </div>
        @else
            <div class='pages'>
                <a href='{{ route('home') }}'class="btn_bac_gray">Главная </a>
                <a href='{{ route('account.organization.beautifications.index') }}'class="btn_bac_gray">Облагораживание</a>
                <a href='{{ route('account.organization.services.index') }}'class="btn_bac_gray">Уборка захоронений</a>
                <a href='{{ route('account.organization.settings') }}'class="btn_bac_gray">Настройки</a>
                <a href='#'class="btn_bac_gray">Чат</a>
            </div>
        @endif
