...
<section class="order_page bac_gray">
    <div class="container">
        <div class="content_order_page">
            <div class="index_title">Морги</div>    
        </div>
...
<section class="cemetery">
    <div class="container">
        ...
        <div class="block_cemetery">
            <div class="title_our_works">Список моргов</div>

            <div class="ul_cemeteries">
                @if (isset($mortuaries) && $mortuaries->count()>0)
                <?php $k=1;?>
                    @foreach ($mortuaries as $mortuary)
                        <a href="{{ route('mortuary.single',$mortuary->id) }}" class="li_cemetery">
...
<section class="map_cemeteries">
    <div class="container">
        <div class="title_our_works">Карта моргов</div>
